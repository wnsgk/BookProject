...
public class MyBookController {
    ...
    @PostMapping("/create")
    public ResponseEntity<Void> createUserBook(@AuthenticationPrincipal PrincipalDetails userDetails,
    ...
    @GetMapping
    public ResponseEntity<MyBook> getUserBook(@AuthenticationPrincipal PrincipalDetails userDetails,
    ...
    @GetMapping("/shelf")
    public ResponseEntity<List<MyBookResDto>> bookList(@RequestParam(name = "userid") Long userId){
